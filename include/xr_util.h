...
//return 0  :f1 == f2
//retrun -1 :f1 < f2
#define FLOAT_COMPARE(__f1__, __f2__) ({(__f1__) - (__f2__) < -FLT_EPSILON ? -1 : (FLT_EPSILON < (__f1__) - (__f2__) ? 1 : 0)})

#define GEN_STR(__str__, ...) ::snprintf(__str__, sizeof(__str__), __VA_ARGS__)

#define SAFE_STRNCPY(__dst__, __src__)                        \
	{                                                         \
		if (__src__)                                          \
		{                                                     \
